              ...
              <div className="bg-white rounded-lg p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
                <div className="shadow-md bg-white overflow-hidden">
                  ...
                  <div className="px-6 mt-16">
                    <label className="text-textTeam font-bold text-3xl text-center pb-1">
                      {item.name}
                    </label>
                    <p className="text-textTeam text-sm ">{item.position}</p>
                    <p className=" text-textTeam pt-3 font-normal">
                      {item.role}
                    </p>
