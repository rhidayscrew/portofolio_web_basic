...
export default function Navbar() {
  ...
  return (
    <header className="border-b-[1px] border-bgRed fixed bg-bgNavbar inset-x-0 top-0 z-50 ">
      <nav className="flex items-center justify-between py-3 px-8">
        <div className="flex lg:flex-1">
          <a className="-m-1.5 p-1.5" href="#">
            <span className="sr-only"> Website Por folio Rahmat Hidayad </span>
            <img
              className="h-14 w-auto"
              src={logo}
              alt="Your Portfolio rahmat hidayad "
            />
          </a>
        </div>
